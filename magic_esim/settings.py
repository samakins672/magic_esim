...
MPGS_API_BASE_URL = config('MPGS_API_BASE_URL', default='')
MPGS_MERCHANT_ID = config('MPGS_MERCHANT_ID', default='')
MPGS_API_USERNAME = config('MPGS_API_USERNAME', default='')
MPGS_API_PASSWORD = config('MPGS_API_PASSWORD', default='')
MPGS_CHECKOUT_URL = config('MPGS_CHECKOUT_URL', default='')
MPGS_API_VERSION = config('MPGS_API_VERSION', default='71')
MPGS_RETURN_URL = config('MPGS_RETURN_URL', default=TAP_REDIRECT_URL)
MPGS_SESSION_TIMEOUT_MINUTES = config('MPGS_SESSION_TIMEOUT_MINUTES', default=15, cast=int)
HYPERPAY_API_BASE_URL = config('HYPERPAY_API_BASE_URL', default='')
HYPERPAY_ENTITY_ID = config('HYPERPAY_ENTITY_ID', default='')
HYPERPAY_ACCESS_TOKEN = config('HYPERPAY_ACCESS_TOKEN', default='')
HYPERPAY_CHECKOUT_URL = config('HYPERPAY_CHECKOUT_URL', default='')
HYPERPAY_PAYMENT_TYPE = config('HYPERPAY_PAYMENT_TYPE', default='DB')
HYPERPAY_RETURN_URL = config('HYPERPAY_RETURN_URL', default=TAP_REDIRECT_URL)
HYPERPAY_CHECKOUT_TIMEOUT_MINUTES = config('HYPERPAY_CHECKOUT_TIMEOUT_MINUTES', default=15, cast=int)

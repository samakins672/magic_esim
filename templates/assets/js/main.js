...
function() {
    ...
    var s, l = localStorage.getItem("templateCustomizer-" + templateName + "--Style") || (window.templateCustomizer?.settings?.defaultStyle ?? "light"), i = (window.templateCustomizer && t && ([].slice.call(t.children[1].querySelectorAll(".dropdown-item")).forEach(function(e) {
    ...
    i = t.querySelector("i"),
    "light" === l ? (i.classList.add("bx-sun"),
    new bootstrap.Tooltip(i,{
        title: "Light Mode",
        fallbackPlacements: ["bottom"]
    })) : "dark" === l ? (i.classList.add("bx-moon"),
    new bootstrap.Tooltip(i,{
        title: "Dark Mode",
        fallbackPlacements: ["bottom"]
